                        ...
                        for j in range(NUM_BATCHES):
                            ...
                            for b_ix in range(BATCH_COPIES):
                                ...
                                if b_ix == 0 and j==0 and temp==temperatures[0]:
                                    ...
                                    f.write(f'>{name_}, score={native_score_print}, fixed_chains={print_visible_chains}, designed_chains={print_masked_chains}, model_name={args.model_name}\n{native_seq}\n') #write the native sequence
                                start = 0
                                end = 0
                                list_of_AAs = []
                                for mask_l in masked_chain_length_list:
                                ...
                                f.write(f'>T={temp}, sample={b_ix}, score={score_print}, seq_recovery={seq_rec_print}\n{seq}\n') #write generated sequence
                if args.save_score:
